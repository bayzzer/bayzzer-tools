...
export class ImmutableManage implements ProducersFns {
	...
	finishDraft<D extends Draft<any>>(
		...
		const state: ImmutableType = draft && (draft as any)[DRAFT_STATE]
...
export function createProxy<T extends Objectish>(
	immer: ImmutableManage,
	value: T,
	parent?: ImmutableType
): Drafted<T, ImmutableType> {
